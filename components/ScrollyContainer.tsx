...
export const ScrollyContainer: React.FC<ScrollyContainerProps> = ({ blocks }) => {
  ...
  return (
    <div className="relative w-full max-w-[1440px] mx-auto">
      ...
      <div className="fixed inset-0 z-0 w-full h-full pointer-events-none md:static md:h-screen md:w-1/2 md:float-right md:sticky md:top-0 flex items-center justify-center">
